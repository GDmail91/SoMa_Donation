 ...
 */
public class PostListAdpater extends RecyclerView.Adapter<PostListAdpater.ViewHolder> {
    Context context;
    List<DTORankItem> items;
    int item_layout;

    public PostListAdpater(Context context, List<DTORankItem> items, int item_layout) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.id.setText(""+item.getContentId());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView id, title, likeCount, viewCount, likeText;
        ...
        public ViewHolder(View itemView) {
            ...
            id = (TextView) itemView.findViewById(R.id.content_id);
